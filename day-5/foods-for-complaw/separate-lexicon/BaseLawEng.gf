concrete BaseLawEng of BaseLaw = open Prelude, SyntaxEng, LexiconEng, ExtendEng in {
  ...
  lin
    ...
    -- : Proposition -> Phrase ;
    QProp prop = mkText (mkUtt (mkQS prop)) questMarkPunct ;  -- makes Proposition into question phrase
    SProp prop = mkText (mkUtt prop) fullStopPunct ;         -- makes Proposition into statement phrase

    -- Make a Proposition
    -- : Item -> Deontic -> Proposition ;
    Pred item deontic = mkCl item deontic ;
